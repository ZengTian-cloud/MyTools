...
public class FriendLastestListUI : FriendListUIBase
{
    public override string LIST_TYPE => "FriendLastestList";
    ...
    {
        List<ContactData> datas = FriendManager.Instance.GetContactDatas(EnumContactType.Stranger);
