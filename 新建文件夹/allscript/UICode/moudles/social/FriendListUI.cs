...
public class FriendListUI : FriendListUIBase
{
    public override string LIST_TYPE => "FriendList";
    ...
    {
        List<ContactData> datas = FriendManager.Instance.GetContactDatas(EnumContactType.Friend, true);
