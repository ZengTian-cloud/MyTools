...
public class ContentSizeFilterParent : UIBehaviour, ILayoutElement, ILayoutSelfController, ILayoutGroup
{
	public enum FitMode
	{
		Width,
	...
	public FitMode fit { get { return m_Fit; } set { m_Fit = value; } }

	[SerializeField]
	public float interval = 0;
	[SerializeField]
	protected float m_MaxSize = int.MaxValue;
	public float maxSize { get { return m_MaxSize; } set { m_MaxSize = value; } }

	[SerializeField]
	protected int m_layoutPriority = 1;
	public int layoutPriority { get { return m_layoutPriority; } set { m_layoutPriority = value; } }
