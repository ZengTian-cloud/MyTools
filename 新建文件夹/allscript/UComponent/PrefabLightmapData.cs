...
public class PrefabLightmapData : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Debug.Log($"--------------lighting:{LightmapSettings.lightmaps.Length}------------asset:{LightmapSettings.lightmaps[0].lightmapColor}");
        Debug.Log($"--------------PrefabLightmapData:{m_LightmapsColor.Length}-------------color:{m_LightmapsColor[0]}");
    }
...
#if UNITY_EDITOR
    [UnityEditor.MenuItem("VR403WorksTools/Bake Prefab Lightmaps")]
